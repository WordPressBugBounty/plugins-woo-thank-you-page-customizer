...
[Go Pro](https://villatheme.com/extensions/woocommerce-thank-you-page-customizer)

### Documentation

- [Getting Started](http://docs.villatheme.com/?item=woo-thank-you-page-customizer)
...
2. Upload `woo-thank-you-page-customizer` to the `/wp-content/plugins/` directory
...
2025.11.24 - version 1.1.9
- Fixed: Fix nonce for ajax actions

2025.09.12 - version 1.1.8
...
2024.02.26 - version 1.1.3
- Fixed: Fixed security

2024.02.16 - version 1.1.2
- Updated: Compatible with WC 8.6.0 and WP6.4.0
- Updated: Update support file

2023.08.11 - version 1.1.1
